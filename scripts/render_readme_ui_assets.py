...
README_ASSETS: tuple[ReadmeAsset, ...] = (
    ReadmeAsset(
        marker="ui-shadow-cube",
        example=REPO / "examples" / "ui_shadow_cube_test.vkf",
        output_name="ui-shadow-cube-gallery.png",
        caption="`examples/ui_shadow_cube_test.vkf` — cube, floor receiver, light marker, and visible cast shadow.",
        wait_ms=1600,
    ),
    ReadmeAsset(
        marker="ui-surface-mirror-demo",
        example=REPO / "examples" / "ui_readme_mirror_showcase.vkf",
        output_name="ui-mirror-gallery.png",
        caption="`examples/ui_readme_mirror_showcase.vkf` — planar mirror scene with textured solids, proxy geometry, and marker impostors.",
        wait_ms=1800,
    ),
    ReadmeAsset(
        marker="ui-surface-screen-shared-world",
        example=REPO / "examples" / "ui_surface_screen_shared_world_test.vkf",
        output_name="ui-screen-gallery.png",
        caption="`examples/ui_surface_screen_shared_world_test.vkf` — embedded screen surface rendering another scene view into world geometry.",
        wait_ms=1800,
    ),
    ReadmeAsset(
        marker="lit-box-texture",
        example=REPO / "examples" / "lit_box_texture.vkf",
        output_name="lit-box-texture.png",
        caption="`examples/lit_box_texture.vkf` — minimal lit textured box scene for materials and procedural textures.",
        wait_ms=1600,
    ),
    ReadmeAsset(
        marker="ui-field-mesh-0d-point-cloud",
        example=REPO / "examples" / "ui_field_mesh_0d_point_cloud.vkf",
        output_name="ui-impostor-gallery.png",
        caption="`examples/ui_field_mesh_0d_point_cloud.vkf` — point-style marker rendering inside the scene/runtime stack.",
        wait_ms=1600,
        source_trim_from="true?>",
    ),
    ReadmeAsset(
        marker="ui-scene-3d-hero",
        example=REPO / "examples" / "ui_scene_3d.vkf",
        output_name="ui-scene-3d-hero.png",
        caption="`examples/ui_scene_3d.vkf` — compact 3D scene with two moving lights and cast shadows.",
        wait_ms=1800,
    ),
    ReadmeAsset(
        marker="ui-shadow-cube-gallery",
        example=REPO / "examples" / "ui_shadow_cube_test.vkf",
        output_name="ui-shadow-cube-gallery.png",
        caption="`examples/ui_shadow_cube_test.vkf` — focused shadow scene with floor receiver and visible light marker.",
        wait_ms=1600,
    ),
    ReadmeAsset(
        ...
        example=REPO / "examples" / "ui_readme_mirror_showcase.vkf",
        output_name="ui-mirror-gallery.png",
        caption="`examples/ui_readme_mirror_showcase.vkf` — mirror showcase with textured solids, reflected geometry, and impostor accents.",
        wait_ms=1800,
    ),
    ReadmeAsset(
        marker="ui-screen-gallery",
        example=REPO / "examples" / "ui_surface_screen_shared_world_test.vkf",
        output_name="ui-screen-gallery.png",
        caption="`examples/ui_surface_screen_shared_world_test.vkf` — screen-in-world rendering on scene geometry.",
        wait_ms=1800,
    ),
    ReadmeAsset(
        marker="ui-impostor-gallery",
        example=REPO / "examples" / "ui_field_mesh_0d_point_cloud.vkf",
        output_name="ui-impostor-gallery.png",
        caption="`examples/ui_field_mesh_0d_point_cloud.vkf` — marker-style point rendering inside a UI frame.",
        wait_ms=1600,
        source_trim_from="true?>",
    ),
    ReadmeAsset(
        marker="ui-cube-white-color-orbit-animation",
        example=REPO / "examples" / "ui_cube_white_color_orbit.vkf",
        output_name="ui-cube-white-color-orbit-frame.png",
        caption="Representative still from `examples/ui_cube_white_color_orbit.vkf`. This slot can later be upgraded to GIF/MP4 generation.",
        wait_ms=1800,
    ),
)
