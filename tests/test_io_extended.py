...
class TestSleepMs:
    ...
    def test_native_file_and_time_host_resetters_restore_callable_surfaces(self) -> None:
        class FakeFileHost:
            def read_bytes(self, path: str) -> bytes:
                return b""
    ...
    def test_set_io_native_hosts_round_trip_through_native_getters(self) -> None:
        class FakeFileHost:
            def read_bytes(self, path: str) -> bytes:
                return b""
