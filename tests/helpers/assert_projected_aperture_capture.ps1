...
try {
  $center = Measure-MeanLuma $bitmap 0.40 0.35 0.60 0.65
  ...
  if ($center -lt 80 -or $outsideMax -gt 20 -or ($center - $outsideMax) -lt 80) {
    throw "projected aperture capture contrast failed: center=$center outsideMax=$outsideMax"
  }
