...
test("two derived bindings close a later demanded expression", () => {
  ...
  try {
    ...
    writeFileSync(source, [
      ...
      '(statement.instructions.length() = 8)?! "dynamic instruction tape length mismatch"',
      "[num] opcode_tape: [",
      ...
      "    validation.machine_ir_numeric_opcode_code(statement.instructions.3.kind),",
      "    validation.machine_ir_numeric_opcode_code(statement.instructions.4.kind),",
      "    validation.machine_ir_numeric_opcode_code(statement.instructions.5.kind),",
      "    validation.machine_ir_numeric_opcode_code(statement.instructions.6.kind),",
      "    validation.machine_ir_numeric_opcode_code(statement.instructions.7.kind)",
      "]",
      "maximum: validation.machine_ir_numeric_opcode_tape_stack_maximum(opcode_tape)",
