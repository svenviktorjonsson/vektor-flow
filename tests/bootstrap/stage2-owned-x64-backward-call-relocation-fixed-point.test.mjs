...
test("Stage 2 relocates a backward function call in a self-hosted x64 artifact", {
  ...
  const work = mkdtempSync(join(rootWork, "i226-"));
  try {
    ...
    writeFileSync(stage2CompilerSource, [
      ...
      "artifact: compiler_stage._compile_tagged_numeric_literal_function_backward_x64(",
    ...
    assert.deepEqual(
      ...
      generated,
      "backward call relocation bytes differ from the selected artifact",
    );
  } finally {
