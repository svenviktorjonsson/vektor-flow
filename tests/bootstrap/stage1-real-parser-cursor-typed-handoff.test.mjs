...
test("real parser cursor preserves a typed numeric function declaration and call", () => {
  ...
  try {
    ...
    writeFileSync(source, [
      ...
      "import_matches: (import_statement.order = 0 /\\ import_statement.token_count = 3 /\\",
      ...
      "function_statements_match: (header_statement.order = 1 /\\ header_statement.token_count = 7 /\\",
      ...
      "    body_statement.order = 2 /\\ body_statement.token_count = 3 /\\",
      ...
      "call_matches: (call_statement.order = 3 /\\ call_statement.token_count = 8 /\\",
