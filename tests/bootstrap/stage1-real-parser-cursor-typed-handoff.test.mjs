...
test("general typed cursor dispatches constant and binary expressions into Machine IR", () => {
  ...
  try {
    ...
    writeFileSync(source, [
      ...
      "    resolved_call.callee, argument.callee, second_parameter.name,",
      "    arguments.count, second_argument.value",
      ")",
      ...
      "    second_parameter.name, arguments.count, second_argument.value",
      ")",
      ...
      "    function_symbol.arity = 2 /\\ resolved_call.kind = \"call\" /\\",
      "    resolved_call.callee = \"twice\" /\\ resolved_call.callee_type = \"fn(num,num)->num\" /\\",
      ...
      "    resolved_call.span.stop.column = 24)",
      'resolution_matches?! "concrete declaration table failed to resolve nested output call"',
      "arena_matches: (parameters.count = 2 /\\ parameter.kind = \"parameter\" /\\",
      ...
      "    second_parameter.name = \"unused\" /\\ second_parameter.type = \"num\" /\\",
      "    arguments.count = 2 /\\",
      "    argument.kind = \"argument\" /\\ argument.call_order = resolved_call.node_order /\\",
      "    argument.position = 0 /\\ argument.callee = \"cpu_count\" /\\",
      "    argument.type = \"int\" /\\ second_argument.position = 1 /\\",
      "    second_argument.has_value /\\ second_argument.value = 7)",
