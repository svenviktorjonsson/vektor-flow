...
test("general typed cursor dispatches constant and binary expressions into Machine IR", () => {
  ...
  try {
    ...
    writeFileSync(source, [
      ...
      ")",
      "typed_import: typed.typed_tagged_cursor_concrete_node(typed_module, 0)",
      "typed_header: typed.typed_tagged_cursor_concrete_node(typed_module, 1)",
      "typed_constant: typed.typed_tagged_cursor_concrete_node(typed_module, 2)",
      "typed_binary: typed.typed_tagged_cursor_concrete_node(typed_module, 3)",
      "typed_output: typed.typed_tagged_cursor_concrete_node(typed_module, 4)",
      ...
      "resolved_call: typed.typed_tagged_resolve_output_call(",
      "    typed_module, declarations, 4",
      ")",
      ...
      "    typed_constant.expression_kind, typed_constant.first_text, typed_constant.op,",
      "    typed_constant.value, typed_constant.type",
      ")",
      "binary_mir: mir.mir_lower_tagged_scalar_expression(",
      "    typed_binary.expression_kind, typed_binary.first_text, typed_binary.op,",
      ...
      "    typed_binary.op, typed_binary.value, resolved_call.callee,",
      ...
      ")",
      "machine_body_matches: mir.mir_tagged_resolved_module_matches(",
      "    concrete_machine, function_symbol.name,",
      "    [parameter.name, second_parameter.name, third_parameter.name],",
      "    typed_binary.value, arguments.count",
      ")",
      ...
      "typed_matches: (typed_module.kind = \"typed_module\" /\\ typed_module.node_count = 5 /\\",
      "    typed_import.kind = \"import\" /\\ typed_import.type = \"module\" /\\",
      "    typed_header.kind = \"function\" /\\ typed_header.type = \"function\" /\\",
      "    typed_header.first_text = \"combine\" /\\ typed_header.second_text = \"first\" /\\",
      "    typed_header.third_text = \"num\" /\\",
      "    typed_constant.kind = \"expr_stmt\" /\\ typed_constant.expression_kind = \"const\" /\\",
      ...
      "    typed_binary.kind = \"expr_stmt\" /\\ typed_binary.expression_kind = \"binary_op\" /\\",
      "    typed_binary.type = \"num\" /\\ typed_binary.first_text = \"first\" /\\",
      "    typed_binary.op = \"STAR\" /\\",
      ...
      "    typed_output.kind = \"expr_stmt\" /\\ typed_output.expression_kind = \"call\" /\\",
      "    typed_output.type = \"unresolved\" /\\ typed_output.first_text = \"combine\")",
      'typed_matches?! "module-wide concrete typed AST lost statements or expression variants"',
      "resolution_matches: (declarations.count = 1 /\\ declarations.imports_system /\\",
      "    function_symbol.name = \"combine\" /\\ function_symbol.parameter_name = \"first\" /\\",
      "    function_symbol.parameter_type = \"num\" /\\ function_symbol.return_type = \"num\" /\\",
      "    function_symbol.arity = 3 /\\ resolved_call.kind = \"call\" /\\",
      "    resolved_call.callee = \"combine\" /\\ resolved_call.callee_type = \"fn(num,num,num)->num\" /\\",
      "    resolved_call.argument_count = 3 /\\ resolved_call.result_type = \"num\" /\\",
      "    resolved_call.span.start.line = 5 /\\ resolved_call.span.start.column = 1 /\\",
      "    resolved_call.span.stop.column = 43)",
      'resolution_matches?! "concrete declaration table failed to resolve nested output call"',
      "arena_matches: (parameters.count = 3 /\\ parameter.kind = \"parameter\" /\\",
      "    parameter.declaration_order = function_symbol.node_order /\\",
      "    parameter.position = 0 /\\ parameter.name = \"first\" /\\",
      "    parameter.type = \"num\" /\\ second_parameter.position = 1 /\\",
      "    second_parameter.name = \"second\" /\\ second_parameter.type = \"num\" /\\",
      "    third_parameter.position = 2 /\\ third_parameter.name = \"third\" /\\",
      "    third_parameter.type = \"num\" /\\ arguments.count = 3 /\\",
      "    argument.kind = \"argument\" /\\ argument.call_order = resolved_call.node_order /\\",
      "    argument.position = 0 /\\ argument.expression_kind = \"call\" /\\",
      "    argument.name = \"cpu_count\" /\\ argument.type = \"int\" /\\",
      "    second_argument.position = 1 /\\ second_argument.expression_kind = \"binary_op\" /\\",
      "    second_argument.name = \"cpu_count\" /\\ second_argument.op = \"STAR\" /\\",
      "    second_argument.has_value /\\ second_argument.value = 2 /\\",
      "    third_argument.position = 2 /\\ third_argument.expression_kind = \"const\" /\\",
      "    third_argument.has_value /\\ third_argument.value = 7 /\\",
      "    argument.token_stop < second_argument.token_start /\\",
      "    second_argument.token_stop < third_argument.token_start)",
      'arena_matches?! "concrete parameter or argument arena lost declaration/call facts"',
      ...
      "machine_matches: (concrete_machine.schema = \"vektorflow.machine_ir\" /\\",
      "    concrete_machine.version = 4 /\\ concrete_machine.output_kind = \"f64\" /\\",
      "    concrete_machine.output_count = 1 /\\ machine_body_matches)",
      'machine_matches?! "concrete arenas did not assemble executable MachineModule"',
