...
test("general typed cursor dispatches constant and binary expressions into Machine IR", () => {
  ...
  try {
    ...
    writeFileSync(source, [
      ...
      ")",
      "call_mir: mir.mir_lower_tagged_resolved_call(",
      "    resolved_call.callee, resolved_call.callee_type,",
      "    resolved_call.argument_callee, resolved_call.argument_type,",
      "    resolved_call.result_type",
      ")",
      "concrete_machine: mir.mir_assemble_tagged_resolved_module(",
      "    function_symbol.name, parameter.name, typed_binary.op, typed_binary.value,",
      "    resolved_call.callee, argument.callee",
      ")",
      "machine_body_matches: mir.mir_tagged_resolved_module_matches(",
      "    concrete_machine, function_symbol.name, parameter.name, typed_binary.value",
      ")",
      ...
      "    typed_header.first_text = \"twice\" /\\ typed_header.second_text = \"value\" /\\",
      ...
      "    typed_binary.type = \"num\" /\\ typed_binary.first_text = \"value\" /\\",
      ...
      "    typed_output.type = \"unresolved\" /\\ typed_output.first_text = \"twice\")",
      ...
      "    function_symbol.name = \"twice\" /\\ function_symbol.parameter_name = \"value\" /\\",
      "    function_symbol.parameter_type = \"num\" /\\ function_symbol.return_type = \"num\" /\\",
      "    function_symbol.arity = 1 /\\ resolved_call.kind = \"call\" /\\",
      "    resolved_call.callee = \"twice\" /\\ resolved_call.callee_type = \"fn(num)->num\" /\\",
      "    resolved_call.argument_callee = \"cpu_count\" /\\",
      "    resolved_call.argument_type = \"int\" /\\ resolved_call.result_type = \"num\" /\\",
      "    resolved_call.span.start.line = 5 /\\ resolved_call.span.start.column = 1 /\\",
      "    resolved_call.span.stop.column = 21)",
      'resolution_matches?! "concrete declaration table failed to resolve nested output call"',
      "arena_matches: (parameters.count = 1 /\\ parameter.kind = \"parameter\" /\\",
      "    parameter.declaration_order = function_symbol.node_order /\\",
      "    parameter.position = 0 /\\ parameter.name = \"value\" /\\",
      "    parameter.type = \"num\" /\\ arguments.count = 1 /\\",
      "    argument.kind = \"argument\" /\\ argument.call_order = resolved_call.node_order /\\",
      "    argument.position = 0 /\\ argument.callee = \"cpu_count\" /\\",
      "    argument.type = \"int\")",
      ...
      "call_mir_matches: (call_mir.instruction_count = 3 /\\",
      "    call_mir.instructions.0.kind = \"call\" /\\",
      "    call_mir.instructions.0.symbol = \"cpu_count\" /\\",
      "    call_mir.instructions.0.argument_count = 0 /\\",
      "    call_mir.instructions.1.kind = \"call\" /\\",
      "    call_mir.instructions.1.symbol = \"twice\" /\\",
      "    call_mir.instructions.1.argument_count = 1 /\\",
      "    call_mir.instructions.2.kind = \"return_f64\")",
      'call_mir_matches?! "resolved output call lost concrete Machine IR"',
