...
test("compiler source demand-lowers tagged multiplication", () => {
  const rootWork = join(root, ".work");
  mkdirSync(rootWork, { recursive: true });
  const work = mkdtempSync(join(rootWork, "i140-tagged-multiplication-"));
  try {
    for (const name of [
      "compiler",
      "lexer",
    ...
    writeFileSync(source, [
      "stage: .compiler",
      'module: stage.compile_tagged_module_statement("value0*2", 0)',
      ":: module.entry.name",
