...
test("compiler source demand-lowers tagged floor division", () => {
  const rootWork = join(root, ".work");
  mkdirSync(rootWork, { recursive: true });
  const work = mkdtempSync(join(rootWork, "i145-tagged-floor-division-"));
  try {
    for (const name of [
      "compiler",
      "lexer",
    ...
    writeFileSync(source, [
      "stage: .compiler",
      'module: stage.compile_tagged_module_statement("value0//4", 0)',
      ":: module.entry.name",
