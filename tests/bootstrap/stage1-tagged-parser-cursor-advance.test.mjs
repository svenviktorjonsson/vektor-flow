...
test("tagged parser cursor advances between heterogeneous values", () => {
  ...
  try {
    ...
    writeFileSync(harness, [
      ...
      "start: parser.tagged_cursor(envelope)",
      "identifier: parser.parse_tagged_identifier(parser.tagged_peek(start))",
      "next: parser.tagged_advance(start)",
      "number: parser.parse_tagged_number(parser.tagged_peek(next))",
      ":: start.index",
      ":: identifier.name",
      ":: next.index",
      ":: number.value",
