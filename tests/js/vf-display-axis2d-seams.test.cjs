...
assert.ok(source.includes("var external = axis2DTicksMethod(\"polarRadialRange\");"));
assert.ok(source.includes("var external = axis2DTicksMethod(\"applyPolarRadialRange\");"));
assert.ok(source.includes("var external = axis2DTicksMethod(\"polarThetaOffset\");"));
assert.ok(source.includes("var external = axis2DTicksMethod(\"setPolarThetaOffset\");"));
