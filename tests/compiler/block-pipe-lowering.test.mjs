...
test("the foldered chess bot advances through the next rebinding gate", {
  ...
  assert.doesNotMatch(
    diagnostic,
    /in function __vkf_module_state__path_clear_on_board: Cannot declare existing name r; update it with \.r:value/u,
  );
  assert.doesNotMatch(
    diagnostic,
    /in function __vkf_module_state__king_piece_on_board: Cannot declare existing name found; update it with \.found:value/u,
  );
  assert.doesNotMatch(
    diagnostic,
    /in function __vkf_module_state__king_piece_on_board: Cannot declare existing name i; update it with \.i:value/u,
  );
  assert.doesNotMatch(
    diagnostic,
    /in function __vkf_module_state__square_attacked_by: Cannot declare existing name attacked; update it with \.attacked:value/u,
  );
  assert.doesNotMatch(
    diagnostic,
    /in function __vkf_module_state__square_attacked_by: Cannot declare existing name i; update it with \.i:value/u,
  );
  assert.doesNotMatch(
    diagnostic,
    /in function __vkf_module_state__direction_has_legal_move: Cannot declare existing name done; update it with \.done:value/u,
  );
  assert.doesNotMatch(
    diagnostic,
    /in function __vkf_module_state__direction_has_legal_move: Cannot declare existing name found; update it with \.found:value/u,
  );
  assert.doesNotMatch(
    diagnostic,
    /in function __vkf_module_state__direction_has_legal_move: Cannot declare existing name f; update it with \.f:value/u,
  );
  assert.doesNotMatch(
    diagnostic,
  ...
  assert.doesNotMatch(
    diagnostic,
    /in function __vkf_module_bot__evaluate_state: Cannot declare existing name score; update it with \.score:value/u,
  );
  assert.match(
    diagnostic,
    /in function __vkf_module_bot__evaluate_state: Cannot declare existing name i; update it with \.i:value/u,
  );
