...
f.add_oval((0.670, 0.463, 0.044, 0.074), color: "#7ddcff")
...
lighting_c: [
  [[0.36, 0.31, 0.18, 1.0], [1.0, 0.88, 0.44, 1.0], [0.56, 0.44, 0.18, 1.0], [0.30, 0.60, 0.78, 1.0]],
  [[0.28, 0.26, 0.22, 1.0], [0.80, 0.64, 0.26, 1.0], [0.22, 0.20, 0.18, 1.0], [0.20, 0.46, 0.66, 1.0]]
] -> uv
g.add(
...
blue_light_x: [[0.80, 0.90], [0.80, 0.90]] -> uv
blue_light_y: [[-0.10, -0.10], [0.10, 0.10]] -> uv
blue_light_z: [[0.0, 0.0], [0.0, 0.0]] -> uv
blue_light_c: [
  [[0.49, 0.86, 1.0, 1.0], [0.49, 0.86, 1.0, 1.0]],
  [[0.24, 0.62, 1.0, 1.0], [0.24, 0.62, 1.0, 1.0]]
] -> uv
g.add(
  id: "layer_1_blue_light_source",
  x: blue_light_x,
  y: blue_light_y,
  z: blue_light_z,
  c: blue_light_c,
