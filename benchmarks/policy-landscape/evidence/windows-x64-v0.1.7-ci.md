...
![Sorted optimizer policy landscape](./windows-x64-v0.1.7-ci.svg)
...
The complete machine-readable evidence, including all 256 policy records, hashes, output, compiler identity, and host conditions, is [windows-x64-v0.1.7-ci.json](./windows-x64-v0.1.7-ci.json).
...
```powershell
node benchmarks/policy-landscape/run.mjs --compiler=build/native-compiler-clang/bin/vkf-strict.exe --runs=200 --output=benchmarks/policy-landscape/evidence/windows-x64-v0.1.7
```
