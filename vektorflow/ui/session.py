...
_ROOT_ASSET_RE = re.compile(
    r'((?:href|src)=["\'])(vf-frame\.css(?:\?[^"\']*)?|vf-frame\.js(?:\?[^"\']*)?|vf-widgets\.js(?:\?[^"\']*)?|vf-display\.js(?:\?[^"\']*)?|vf-runtime-shell\.js(?:\?[^"\']*)?|vf-runtime-source\.js(?:\?[^"\']*)?|vf-runtime-scene\.js(?:\?[^"\']*)?|vf-runtime-flow\.js(?:\?[^"\']*)?|katex/[^"\']+|geom/[^"\']+)(["\'])'
)
