  ...
  function createVkfSharedRectProgram() {
    ...
    return {
      ...
      update: function (input, api) {
        ...
        if (!wasPointerDown) {
          ui.selection.select(e.hover, ui.keyboard.modifiers);
          activeTargets = ui.selection.items_or([e.hover]);
          wasPointerDown = true;
        }
