...
- It exposes only the native 0.1.6 compiler surface; unavailable `ui`, `physics`,
...
2. Install VKF 0.1.6 or build the native compiler using the repository installation guide.
